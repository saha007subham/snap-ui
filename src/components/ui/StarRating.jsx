...
export const StarRating = forwardRef(
  (
    ...
    // Temporary value when hovering
    const [hoverRating, setHoverRating] = useState(null);
    // Track active keyboard-focused index (-1 means container has focus, or specific stars have focus)
    ...
    // Calculate dynamic width fraction of active/hover stars
      ...
      >
        ...
        >
          {Array.from({ length: maxStars }).map((_, index) => {
            ...
            const isHovered = hoverRating !== null && index < Math.ceil(hoverRating);
            ...
            return (
              ...
              >
                ...
                {/* Framer motion overlay for popping effect on selection */}
                <AnimatePresence>
